...
const ItemOptions = class {
  ...
  render() {
    const mode = Object(_ionic_global_9d5c8ee3_js__WEBPACK_IMPORTED_MODULE_1__["b"])(this);
    const isEnd = Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["j"])(this.side);
...
const ItemSliding = class {
  ...
  async updateOptions() {
    ...
    for (let i = 0; i < options.length; i++) {
      ...
      const side = Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["j"])(option.side) ? 'end' : 'start';
      if (side === 'start') {
