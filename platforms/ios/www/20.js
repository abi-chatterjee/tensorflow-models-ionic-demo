...
/* harmony import */ var _index_35146240_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-35146240.js */ "./node_modules/@ionic/core/dist/esm/index-35146240.js");
...
/* harmony import */ var _overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./overlays-0fa8307b.js */ "./node_modules/@ionic/core/dist/esm/overlays-0fa8307b.js");
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const onMove = (detail) => {
    const step = Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["e"])(0.0001, detail.deltaY / height, 0.9999);
...
const iosEnterAnimation = (baseEl, presentingEl) => {
  const backdropAnimation = Object(_animation_ede2d71c_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
  ...
  const wrapperAnimation = Object(_animation_ede2d71c_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
  ...
  if (presentingEl) {
    ...
    const presentingAnimation = Object(_animation_ede2d71c_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
      .beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = Object(_animation_ede2d71c_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
          .afterStyles({
          'transform': finalTransform
        })
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_9__["B"]);
    };
    this.onDismiss = (ev) => {
      ev.stopPropagation();
      ev.preventDefault();
  ...
  async present() {
    ...
    await Object(_index_35146240_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this.usersElement);
    Object(_index_e806d1f6_js__WEBPACK_IMPORTED_MODULE_0__["c"])(() => this.el.classList.add('show-modal'));
    await Object(_overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_9__["d"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
  ...
  async dismiss(data, role) {
    ...
    const enteringAnimation = _overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_9__["h"].get(this) || [];
    const dismissed = await Object(_overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_9__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
    if (dismissed) {
