...
const Router = class {
  ...
  componentDidLoad() {
    window.addEventListener('ionRouteRedirectChanged', Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["k"])(this.onRedirectChanged.bind(this), 10));
    window.addEventListener('ionRouteDataChanged', Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["k"])(this.onRoutesChanged.bind(this), 100));
  }
  async onPopState() {
