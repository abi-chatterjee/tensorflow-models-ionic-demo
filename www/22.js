...
/* harmony import */ var _overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlays-0fa8307b.js */ "./node_modules/@ionic/core/dist/esm/overlays-0fa8307b.js");
...
const mdEnterAnimation = (baseEl, ev) => {
  ...
  const backdropAnimation = Object(_animation_ede2d71c_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
  const wrapperAnimation = Object(_animation_ede2d71c_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
  const contentAnimation = Object(_animation_ede2d71c_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
  const viewportAnimation = Object(_animation_ede2d71c_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
  backdropAnimation
    .addElement(baseEl.querySelector('ion-backdrop'))
    .fromTo('opacity', 0.01, 'var(--backdrop-opacity)')
    .beforeStyles({
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_6__["B"]);
    };
  ...
  async present() {
    ...
    return Object(_overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, this.event);
  }
  /**
  ...
  async dismiss(data, role) {
    const shouldDismiss = await Object(_overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_6__["f"])(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event);
    if (shouldDismiss) {
