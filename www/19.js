...
/* harmony import */ var _index_9ba1f74f_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-9ba1f74f.js */ "./node_modules/@ionic/core/dist/esm/index-9ba1f74f.js");
...
`);
  ...
  async loadAnimation() {
    ...
    this.animation = await _index_9ba1f74f_js__WEBPACK_IMPORTED_MODULE_7__["m"]._createAnimation(this.type, this);
  ...
  beforeAnimation(shouldOpen) {
    Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["i"])(!this.isAnimating, '_before() should not be called while animating');
  ...
  afterAnimation(isOpen) {
    Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["i"])(this.isAnimating, '_before() should be called while animating');
...
const updateVisibility = async (menu) => {
  const menuEl = await _index_9ba1f74f_js__WEBPACK_IMPORTED_MODULE_7__["m"].get(menu);
...
const MenuButton = class {
  constructor(hostRef) {
    ...
    this.type = 'button';
    this.onClick = async () => {
      return _index_9ba1f74f_js__WEBPACK_IMPORTED_MODULE_7__["m"].toggle(this.menu);
    };
  }
  componentDidLoad() {
