...
const Toast = class {
   ...
   */
  async present() {
    await Object(_overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position);
    if (this.duration > 0) {
  ...
  async callButtonHandler(button) {
    if (button && button.handler) {
      ...
      try {
        const rtn = await Object(_overlays_0fa8307b_js__WEBPACK_IMPORTED_MODULE_6__["s"])(button.handler);
        if (rtn === false) {
