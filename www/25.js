...
const Range = class {
  constructor(hostRef) {
    ...
    this.clampBounds = (value) => {
      return Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["e"])(this.min, value, this.max);
    };
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["e"])(0, this.ratioA + step, 1);
      }
      else {
        this.ratioB = Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["e"])(0, this.ratioB + step, 1);
      }
      this.updateValue();
    };
    this.onBlur = () => {
  ...
  onStart(detail) {
    ...
    let ratio = Object(_helpers_002e4980_js__WEBPACK_IMPORTED_MODULE_2__["e"])(0, (currentX - rect.left) / rect.width, 1);
    if (document.dir === 'rtl') {
      ratio = 1 - ratio;
    }
    this.pressedKnob =
